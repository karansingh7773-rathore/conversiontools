                                ...
                                {mode === 'canvas' && (
                                    <div className="space-y-3">
                                        ...
                                        <div
                                            ...
                                            className="border border-gray-300 dark:border-gray-600 rounded-lg bg-white h-24 flex items-center justify-center cursor-pointer hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors"
                                        >
                                            {currentSignature ? (
                                ...
                                {mode === 'image' && (
                                    <div className="space-y-3">
                                        ...
                                        <button
                                            ...
                                            className="w-full px-3 py-3 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-600 dark:text-gray-400 hover:border-blue-500 hover:text-blue-500 transition-colors"
                                        >

...
const OrganizeEditor: React.FC<OrganizeEditorProps> = ({ files, onClose, onAddMoreFiles }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 bg-gray-100 dark:bg-gray-900 flex flex-col">
            ...
            {/* Desktop Toolbar */}
            {!isMobile && (
                <div className="px-6 py-3 bg-gray-50 dark:bg-gray-800/50 border-b border-gray-200 dark:border-gray-700 flex items-center gap-4">
                    <button
                        onClick={toggleSelectAll}
                        className="flex items-center gap-2 px-3 py-1.5 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-lg text-sm"
                    >
                    ...
                    <>
                        ...
                        <div className="flex justify-center mt-6">
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 rounded-lg text-sm font-medium"
                            >
            ...
            {isMobile && (selectionMode || selectedCount > 0) && (
                <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 px-4 py-3 flex items-center justify-around shadow-lg z-30">
                    <button
                        onClick={() => rotateSelected('ccw')}
